...
static const NSString *LXEmptyViewAssociatedKey = @"LXEmptyViewAssociatedKey";
static const NSString *LXEmptyViewHideSeparatorLinesAssociatedKey = @"LXEmptyViewHideSeparatorLinesAssociatedKey";
static const NSString *LXEmptyViewPreviousSeparatorStyleAssociatedKey = @"LXEmptyViewPreviousSeparatorStyleAssociatedKey";
...
- (UIView *)emptyView; {
    return objc_getAssociatedObject(self, &LXEmptyViewAssociatedKey);
}
...
- (void)setEmptyView:(UIView *)emptyView; {
    ...
    objc_setAssociatedObject(self, &LXEmptyViewAssociatedKey, emptyView, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    [self updateEmptyView];
}

- (BOOL)hideSeparatorLinesWheyShowingEmptyView {
    NSNumber *hideSeparator = objc_getAssociatedObject(self, &LXEmptyViewHideSeparatorLinesAssociatedKey);
...
- (void)setHideSeparatorLinesWhenShowingEmptyView:(BOOL)value {
    ...
    objc_setAssociatedObject(self, &LXEmptyViewHideSeparatorLinesAssociatedKey, hideSeparator, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
...
- (UITableViewCellSeparatorStyle)previousSeparatorStyle {
    NSNumber *previousSeparatorStyle = objc_getAssociatedObject(self, &LXEmptyViewPreviousSeparatorStyleAssociatedKey);
...
- (void)setPreviousSeparatorStyle:(UITableViewCellSeparatorStyle)value {
    ...
    objc_setAssociatedObject(self, &LXEmptyViewPreviousSeparatorStyleAssociatedKey, previousSeparatorStyle, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
